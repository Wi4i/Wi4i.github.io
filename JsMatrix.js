...
if (d === 0){
            alert('Определитель равен нулю. Система не имеет решений.');
	return;
}
...
if ((Number.isNaN(x) ) &&
    (Number.isNaN(y) ) &&
    (Number.isNaN(z) )){
     alert('Введено некорректное значение. Проверьте правильность вводимых данных. Матрица должна содержать только числовые значения.')
   } else {
     alert('x = ' + x + ' y = ' + y + ' z = ' + z); 
   }
